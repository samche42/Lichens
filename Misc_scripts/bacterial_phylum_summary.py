...
final_count_df.to_csv("Bacterial_phyla_counts.txt", sep='\t', index=False)
final_abund_df.to_csv("Bacterial_phyla_abundances.txt", sep='\t', index=False)
final_length_df.to_csv("Bacterial_phyla_lengths.txt", sep='\t', index=False)
