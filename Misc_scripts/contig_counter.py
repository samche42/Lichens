...
counts_df.to_csv("Kingdom_contig_counts.txt", sep='\t', index=False)
abundances_df.to_csv("Kingdom_contig_abundances.txt", sep='\t', index=False)
lengths_df.to_csv("Kingdom_contig_lengths.txt", sep='\t', index=False)
