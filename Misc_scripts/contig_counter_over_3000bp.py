...
counts_df.to_csv("Kingdom_contig_counts_over_3000bp.txt", sep='\t', index=False)
abundances_df.to_csv("Kingdom_contig_abundances_over_3000bp.txt", sep='\t', index=False)
lengths_df.to_csv("Kingdom_contig_lengths_over_3000bp.txt", sep='\t', index=False)
