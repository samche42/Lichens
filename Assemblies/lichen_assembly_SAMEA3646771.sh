...
cat *_1P.fastq > SAMEA3646771_1.fastq
cat *_2P.fastq > SAMEA3646771_2.fastq

#SPADES ASSEMBLY
echo "Starting assembly of $acc..."
spades.py -t 25 -m 500 \
--pe1-1 SAMEA3646771_1.fastq --pe1-2 SAMEA3646771_2.fastq \
-o SAMEA3646771_Spades_Output

mv SAMEA3646771_Spades_Output/scaffolds.fasta SAMEA3646771_scaffolds.fasta #Move scaffold file out and rename
rm -r SAMEA3646771_Spades_Output
tar czvf SAMEA3646771_scaffolds.fasta.tar.gz SAMEA3646771_scaffolds.fasta
rm *.fastq
rm SAMEA3646771_scaffolds.fasta
