...
cat *_1P.fastq > SAMN07318404_1.fastq
cat *_2P.fastq > SAMN07318404_2.fastq

#SPADES ASSEMBLY
echo "Starting assembly of $acc..."
spades.py -t 25 -m 500 \
--pe1-1 SAMN07318404_1.fastq --pe1-2 SAMN07318404_2.fastq \
-o SAMN07318404_Spades_Output

mv SAMN07318404_Spades_Output/scaffolds.fasta SAMN07318404_scaffolds.fasta #Move scaffold file out and rename
rm -r SAMN07318404_Spades_Output
tar czvf SAMN07318404_scaffolds.fasta.tar.gz SAMN07318404_scaffolds.fasta
rm *.fastq
rm SAMN07318404_scaffolds.fasta
mv SAMN07318404_scaffolds.fasta.tar.gz ../
