...
#SBATCH --error=/home/simonsonsc/Slurm_scripts/log_files/CAT.%J.err
#SBATCH --output=/home/simonsonsc/Slurm_scripts/log_files/CAT.%J.out
...
cd /mnt/projects/abcs-dssb/mtp/slurm/simonsonsc/Lichen_project/Acceptable_assemblies/

source /mnt/nasapps/development/python/miniconda3/3.10/bin/activate CAT

CAT contigs -c ${input_file} \
    -d /mnt/projects/bioinfo/legacy/SeqIdx/cat/CAT_prepare_20210107/2021-01-07_CAT_database \
    -t /mnt/projects/bioinfo/legacy/SeqIdx/cat/CAT_prepare_20210107/2021-01-07_taxonomy \
